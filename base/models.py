...
class Ocupacion(models.Model):
    """!
    Clase que gestiona los datos de las ocupaciones
    ...
    ## Contiene el nombre de la ocupación
    nombre = models.CharField(max_length=75)

    ## Contiene una descripción sobre la ocupación
    descripcion = models.CharField(max_length=255)

    class Meta:
        """!
        Metaclase que permite establecer las propiedades de la clase Ocupacion
    ...
    def __str__(self):
        """!
        Método que muestra la información sobre la ocupación

        @author Ing. Roldan Vargas (rvargas at cenditel.gob.ve)
        @copyright <a href='http://www.gnu.org/licenses/gpl-2.0.html'>GNU Public License versión 2 (GPLv2)</a>
        @date 19-08-2016
        @param self <b>{object}</b> Objeto que instancia la clase
        @return Devuelve los datos de la ocupación
        """
        return "%s" % six.text_type(self.nombre)